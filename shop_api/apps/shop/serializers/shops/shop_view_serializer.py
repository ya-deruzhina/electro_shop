...
class ShopsSerializer(serializers.Serializer):
    ...
    type_shop = serializers.ChoiceField(choices=TYPE_SHOPS)
    category_supplier = CategorySerializer(required=False)
    debt_to_supplier = serializers.DecimalField(max_digits=10, decimal_places=2, read_only = True)
